...
1. **"COMMENT"** — if the PR author is `nathanjnorris`, this is the same account as the current GitHub PAT in use. As you cannot approve or request changes on your own PR, you will get an error unless you submit a COMMENT `event` type for `nathanjnorris`.
